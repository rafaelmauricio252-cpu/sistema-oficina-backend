        ...
        lista.innerHTML = `
            <div class="item-card">
                <div class="item-header">
                    ...
                    <button type="button" class="btn-danger" onclick="removerFotoSelecionada()">
                        🗑️ Remover
                    </button>
                </div>
                <div class="item-body">
...
async function uploadFotoOS(osId) {
    ...
    try {
        ...
        if (response.ok && data.sucesso) {
            ...
            showToast(data.erro || 'OS criada, mas houve erro ao enviar a foto', 'warning');
        }
    } catch (error) {
        console.error('Erro ao fazer upload da foto:', error);
        showToast('OS criada, mas ocorreu erro ao enviar a foto', 'warning');
    }
}
